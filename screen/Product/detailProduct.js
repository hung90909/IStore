...
import { StyleSheet, Text, View, Image, TextInput, TouchableOpacity, 
    SafeAreaView, FlatList , ToastAndroid} from 'react-native';
...
export default function DetailProduct(props) {
    ...
    return (
        <View style={{ flex: 1, backgroundColor: "#DCDCDC" }}>
                        ...
                        <View>
                            ...
                            <View style={{
                                ...
                                <View style={{ padding: 10 }}>
                                    ...
                                    <Text style={{
                                        color: "red", fontSize: 17, marginTop: 10, 
                                    }}>{item.price}$</Text>
                                    <View style={{
                                        flexDirection: "row", justifyContent: "space-between",
                                        width: "100%", alignItems: "center", marginTop: 15, 
                                    }}>
                                        <View style={{ flexDirection: "row" }}>
                                            <FiveStar numberStar={item.review} height={10} width={10} />
                                        </View>
                            ...
                            <View style={{
                                backgroundColor: "white", marginTop: 10, padding: 10
                            }}>
                                    ...
                                    renderItem={({ item }) => {
                                        return (
                                            <TouchableOpacity
                                                ...
                                                style={{
                                                    width: 100, minHeight: 150, borderWidth: 0.5,
                                                    borderColor: "gray", marginRight: 10, marginTop: 10
                                                }}>
                                                <Image
                                                    style={{
                                                        width: "100%", height: 80
                                                ...
                                                <View style={{ padding: 3 }}>
                                                    ...
                                                    <View style={{ flexDirection: "row", marginTop: 3 }}>
                                                        <FiveStar numberStar={item.review} width={7} height={7} />
                                                    </View>
                                                    <Text style={{
                            ...
                            <View style={{
                                backgroundColor: "white", padding: 10, marginTop: 10
                            }}>
            ...
            />
            <View style={{
                 position: "absolute", top: 10, left: 10 , flexDirection:"row", justifyContent:"space-between"
                 , width:"100%",
            }}>
                <TouchableOpacity
                    onPress={() => {
