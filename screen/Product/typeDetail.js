...
export default function TypeDetail(props) {
    ...
    return (
        <SafeAreaView style={{ backgroundColor: "#DCDCDC", flex: 1 }}>
            <View style={{
                backgroundColor: "red", height: 50, justifyContent: "center",
                paddingStart: 10
            }}>
                <View style={{ flexDirection: "row", alignItems: "center" }}>
                    ...
                    <Text style={{ marginStart: 10, fontWeight: "bold", fontSize: 18, color: "white" }}>{item.product_type}</Text>
                </View>
                ...
                renderItem={({ item }) => {
                    return (
                        <TouchableOpacity style={{
                            width: "100%", marginVertical: 10, flexDirection: "row",
                            padding: 5, borderBottomColor: "gray", borderBottomWidth: 0.5
                        }}>
                            <Image style={{
                                width: 100, height: 100, borderColor: "black", borderWidth: 1
                            }} source={{ uri: item.image }} />
                            <View style={{
                                width: 35, height: 35, backgroundColor: "#FFD700", position: "absolute",
                                left: 70, top: 5, justifyContent: "center", alignItems: "center", padding: 4
                            }}>
                            ...
                            <View style={{ marginStart: 10 }}>
                                ...
                                <View style={{
                                    ...
                                    <Text style={{ fontSize: 20, color: "red", marginTop: 5 }}>{item.price}$</Text>
                                    <TouchableOpacity
                                    onPress={()=>{
                                        nav.navigate("Pay",{item})
                                    }}
                                     style={{
                                        backgroundColor: "red", marginBottom: 6
                                    }}>
                                        <Text style={{
