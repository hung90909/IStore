...
export default function Register(props) {
    ...
    const checkValidate = () => {
        if (checkEmail(email) && checkPassword(password) && checkRe_Passwords(rePassword , password) ) {
            onRegister()
        }
    }
    return (
                ...
                <View style={{
                    ...
                    <TextInput
                        ...
                        style={{
                            ...
                            marginTop: 30, paddingStart: 10, width: "75%", borderRadius: 10,
                            alignSelf: "center", borderColor: errorEmail ? "red" : null,
                            borderWidth: 1
                        }}
                    ...
                    <TextInput
                        ...
                        style={{
                            height: 40, width: "100%",
                            backgroundColor: 'white',
                            marginTop: 15, paddingStart: 10, width: "75%",
                            borderRadius: 10, alignSelf: "center",
                            borderColor: errorPassword ? "red" : null,
                            borderWidth: 1
                        }}
                        placeholder='Enter password...' />
                    {errorPassword && <Text style={{ color: "red", marginStart: 50 }}>{errorPassword}</Text>}
                    <TextInput
                        onChangeText={(text) => {
                    ...
                    {errorRePassword && <Text style={{ color: "red", marginStart: 50 }}>{errorRePassword}</Text>}
                    <TouchableOpacity
                        onPress={() => {
                            checkValidate()
                        }}
                        style={{
                            width: "75%", backgroundColor: "black", marginTop: 30, height: 40,
